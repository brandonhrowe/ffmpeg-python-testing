...
filtered_output = list(filter(lambda x : "Parsed_showinfo_1" in x, output))
final_output = list(map(lambda y : next(filter(lambda z : z.startswith("pts_time"), y.split(" ")), None), filtered_output))
print(final_output)
